    ...
    private void btnDangnhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangnhapActionPerformed
        ...
        if (check()){
            for (NhanVien nhanVien : lstNhanVien) {
                if (nhanVien.getMaNhanVien().equals(txtTaiKhoan.getText().trim()) && nhanVien.getMatKhau().equals(String.valueOf(txtMatKhau.getPassword()))) {
                    kt = true;
                    nvs = nhanVien;

                } else if (nhanVien.getMaNhanVien().equals(txtTaiKhoan.getText().trim()) && !nhanVien.getMatKhau().equals(String.valueOf(txtMatKhau.getPassword()))) {
