...
public class QuenMatKhau extends javax.swing.JFrame {
    ...
    private void btnSentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSentActionPerformed
        // TODO add your handling code here:
        if(check()==true){
            ArrayList<model.NhanVien> lst = nvRepo.getAllNV();
            String ranDom = passwordrandom();
            for (model.NhanVien nhanVien : lst) {
                if(nhanVien.getEmail().equals(txtEmail.getText().trim())){
                    System.out.println(""+nhanVien.getHoVaTen());
                    guiMail(ranDom);
                    nvRepo.updatePass(txtEmail.getText(), nhanVien.getMaNhanVien());
                }
            }
        }
    ...
    private void guiMail(String pass){
        try {
            ...
            String accountname = "ntinh4939@gmail.com";
            String accountpass = "tolatinh";
