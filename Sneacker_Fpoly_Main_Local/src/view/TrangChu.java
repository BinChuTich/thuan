...
public class TrangChu extends javax.swing.JFrame {
    ...
    public TrangChu() {
        ...
        lblTenNguoiDung.setText(nv.getHoVaTen());
        new jplBanHang().setVisible(true);
        phanQuyen();
    }
    ...
    public void phanQuyen() {
        if (!nv.getIDCV().getMaChucVu().equals("CV1")) {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnBanhang, btnHoadon, btnKhuyenmai, btnSanpham, btnThoat, btnThongke, btnTrangchu});
        ...
        lblTenNguoiDung.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblTenNguoiDung.setText("Phạm Minh Quân ");
