    ...
    public ArrayList<HoaDon> getAllHoaDon(int page) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                nhanVien = nhanVienRepository.getNVByID(rs.getString("idNhanVien"));
                khachHang = khachHangRepository.getKhachHangById(rs.getString("idKhachHang"));
                khuyenMai = khuyenMaiRepository.getKhuyenMaiById(rs.getString("idKhuyenMai"));
    ...
    public ArrayList<HoaDon> searchHoaDon(String keyword) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                NhanVien nv = nhanVienRepository.getNVByID(rs.getString("idNhanVien"));
                KhachHang kh = khachHangRepository.getKhachHangById(rs.getString("idKhachHang"));
                KhuyenMai km = khuyenMaiRepository.getKhuyenMaiById(rs.getString("idKhuyenMai"));
